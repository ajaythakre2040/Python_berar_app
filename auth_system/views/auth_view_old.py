...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        agent_browser = data.get("agent_browser")
...
class TwoFactorVerifyView(APIView):
    ...
    def post(self, request):
        ...
        agent_browser = request.data.get("agent_browser", "Unknown")
        ...
        otp_record = OTP.objects.filter(user_id=user_id).order_by("-id").first()
