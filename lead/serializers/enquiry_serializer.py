...
class EnquirySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "nature_of_business",
            "nature_of_business_display",
            "income",
            "interested",
            "kyc_collected",
            "kyc_document",
            "kyc_document_display",
            "kyc_number",
            "is_status",
            "is_status_display",
            "is_steps",
    ...
    def get_department_name(self, obj):
            if obj.created_by:
                try:
                    ...
                    # User dhundiye aur uska department fetch kijiye
                    user = TblUser.objects.filter(id=obj.created_by).select_related('department_id').first()
                    
                    if user and user.department_id:
                        # Aapke model ke hisab se field ka naam 'department_name' hai
